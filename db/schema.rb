...
ActiveRecord::Schema.define(version: 20160304204933) do
  ...
  add_index "social_profiles", ["user_id", "service_name"], name: "index_social_profiles_on_user_id_and_service_name", using: :btree
